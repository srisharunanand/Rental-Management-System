...
const COMPLAINTS: {
  id:string; title:string; tenant:string; initials:string; unit:string;
  property:string; category:string; status:CompStatus; priority:Priority;
  date:string; note:string; grad:string;
}[] = [
  { id:"MR-042", title:"Leaking tap in kitchen",       tenant:"Rahul Krishnan", initials:"RK", unit:"Unit 4B", property:"Greenview Apt",  category:"Plumbing",   status:"in-progress", priority:"high",   date:"Feb 28", note:"Technician scheduled Mar 6",       grad:"linear-gradient(135deg,#06b6d4,#8b5cf6)" },
  { id:"MR-041", title:"AC not cooling properly",      tenant:"Priya Mehta",    initials:"PM", unit:"Unit 2A", property:"Sunrise Villas", category:"Electrical", status:"open",        priority:"medium", date:"Feb 25", note:"Awaiting owner approval",          grad:"linear-gradient(135deg,#f59e0b,#ef4444)" },
  { id:"MR-039", title:"Main door hinge broken",       tenant:"Suresh Sharma",  initials:"SS", unit:"Unit 1C", property:"Palm Heights",   category:"Carpentry",  status:"open",        priority:"high",   date:"Feb 22", note:"Parts being arranged",             grad:"linear-gradient(135deg,#ef4444,#ec4899)" },
  { id:"MR-038", title:"Water heater not working",     tenant:"Anjali Nair",    initials:"AN", unit:"Unit 3D", property:"Greenview Apt",  category:"Electrical", status:"in-progress", priority:"medium", date:"Feb 20", note:"Plumber visited, needs spare part", grad:"linear-gradient(135deg,#22c55e,#06b6d4)" },
  { id:"MR-035", title:"Paint peeling in bedroom",     tenant:"Divya Varma",    initials:"DV", unit:"Unit 5A", property:"Palm Heights",   category:"Painting",   status:"resolved",    priority:"low",    date:"Feb 10", note:"Repainted on Feb 15",              grad:"linear-gradient(135deg,#8b5cf6,#6366f1)" },
  { id:"MR-031", title:"Lift frequently stops",        tenant:"Karthik Raj",    initials:"KR", unit:"Unit 6B", property:"Royal Enclave",  category:"Mechanical", status:"resolved",    priority:"high",   date:"Jan 28", note:"AMC team fixed on Feb 2",          grad:"linear-gradient(135deg,#06b6d4,#22c55e)" },
];
