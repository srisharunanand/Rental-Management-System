...
const LEASES: {
  ...
  start:string; end:string; rent:string; deposit:string; status:LeaseStatus; grad:string; monthsLeft:number;
}[] = [
  { id:"LSE-001", tenant:"Rahul Krishnan", initials:"RK", unit:"Unit 4B", property:"Greenview Apt",  start:"Jan 1 2024",  end:"Dec 31 2026", rent:"₹18,000", deposit:"₹36,000", status:"active",   grad:"linear-gradient(135deg,#06b6d4,#8b5cf6)", monthsLeft:9 },
  { id:"LSE-002", tenant:"Priya Mehta",    initials:"PM", unit:"Unit 2A", property:"Sunrise Villas", start:"Mar 1 2023",  end:"Apr 30 2025", rent:"₹22,000", deposit:"₹44,000", status:"expiring", grad:"linear-gradient(135deg,#f59e0b,#ef4444)", monthsLeft:2 },
  { id:"LSE-003", tenant:"Suresh Sharma",  initials:"SS", unit:"Unit 1C", property:"Palm Heights",   start:"Jun 1 2022",  end:"May 31 2024", rent:"₹15,000", deposit:"₹30,000", status:"expired",  grad:"linear-gradient(135deg,#ef4444,#ec4899)", monthsLeft:0 },
  { id:"LSE-004", tenant:"Anjali Nair",    initials:"AN", unit:"Unit 3D", property:"Greenview Apt",  start:"Nov 1 2023",  end:"Oct 31 2025", rent:"₹20,000", deposit:"₹40,000", status:"active",   grad:"linear-gradient(135deg,#22c55e,#06b6d4)", monthsLeft:7 },
  { id:"LSE-005", tenant:"Divya Varma",    initials:"DV", unit:"Unit 5A", property:"Palm Heights",   start:"Feb 1 2024",  end:"Jan 31 2027", rent:"₹17,500", deposit:"₹35,000", status:"active",   grad:"linear-gradient(135deg,#8b5cf6,#6366f1)", monthsLeft:10 },
  { id:"LSE-006", tenant:"Karthik Raj",    initials:"KR", unit:"Unit 6B", property:"Royal Enclave",  start:"Apr 1 2023",  end:"May 31 2025", rent:"₹30,000", deposit:"₹60,000", status:"expiring", grad:"linear-gradient(135deg,#06b6d4,#22c55e)", monthsLeft:3 },
];
...
export default function LeasesPage() {
  ...
  const [selected,   setSelected]   = useState<typeof LEASES[0]|null>(null);
