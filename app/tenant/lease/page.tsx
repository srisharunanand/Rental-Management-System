...
export default function TenantLeasePage() {
  ...
  const progressPct = Math.round(((LEASE.totalMonths - LEASE.monthsLeft) / LEASE.totalMonths) * 100);
  const daysLeft    = LEASE.monthsLeft * 30;
    ...
    <>
      ...
      <main className="page-main">
        ...
        <div className="a1" style={{marginBottom:22}}>
          ...
          <div style={{fontSize:13,color:"#94a3b8",marginTop:3}}>{LEASE.id} · {LEASE.type}</div>
        </div>
        ...
        <div className="glass-card a2" style={{marginBottom:18}}>
          ...
          <div style={{display:"flex",gap:8,marginTop:16,flexWrap:"wrap"}}>
            {[
              {label:"Lease ID",      value:LEASE.id,                         color:"#06b6d4"},
